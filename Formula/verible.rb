class Verible < Formula
  ...
  url "https://github.com/google/verible.git",
      tag:      "v0.0-1149-g7eae750",
      revision: "7eae750fdccbecf3a26207719ce0adb1cf28b9c1"
  version "0.0-1149-g7eae750"
  license "Apache-2.0"

  bottle do
    root_url "https://github.com/google/homebrew-verible/releases/download/verible-0.0-1149-g7eae750"
